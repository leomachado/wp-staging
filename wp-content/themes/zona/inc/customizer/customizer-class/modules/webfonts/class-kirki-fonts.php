...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'zona' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'zona' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'zona' ),
			'200'       => esc_attr__( 'Light 200', 'zona' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'zona' ),
			'300'       => esc_attr__( 'Book 300', 'zona' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'zona' ),
			'400'       => esc_attr__( 'Normal 400', 'zona' ),
			'regular'   => esc_attr__( 'Normal 400', 'zona' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'zona' ),
			'500'       => esc_attr__( 'Medium 500', 'zona' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'zona' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'zona' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'zona' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'zona' ),
			'700'       => esc_attr__( 'Bold 700', 'zona' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'zona' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'zona' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'zona' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'zona' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'zona' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'zona' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'zona' ),
		);
	}
